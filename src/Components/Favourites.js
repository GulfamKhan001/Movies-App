    ...
    return (
      <div class="row">
        ...
        <div class="col favourites-table">
          <div class="row">
            <input type="text" className="col-8" placeholder="Search" value={this.state.currText}
              onChange={this.handleText}></input>
            <input type="number" className="col-4" placeholder="5" value={this.state.limit} onChange={this.handleLimit}></input>
          </div>
          <div class="row">
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th><i class="fa-solid fa-caret-up" onClick={this.sortPopularityAsc} />
                    Popularity
